...
namespace AT.MIN
{
	...
	{
        static System.Globalization.CultureInfo DefaultCultureInfo = System.Globalization.CultureInfo.GetCultureInfo("en-US");
											...
											char Padding, object Value )
		{
			...
			if ( IsNumericType( Value ) )
			{
                w = String.Format(DefaultCultureInfo, numberFormat, Value);
